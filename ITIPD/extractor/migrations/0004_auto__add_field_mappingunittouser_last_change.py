...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MappingUnitToUser.last_change'
        db.add_column('extractor_mappingunittouser', 'last_change',
                      self.gf('django.db.models.fields.DateTimeField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MappingUnitToUser.last_change'
        db.delete_column('extractor_mappingunittouser', 'last_change')
