...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MappingUnitToUser.unmarked_chars'
        db.add_column('extractor_mappingunittouser', 'unmarked_chars',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MappingUnitToUser.unmarked_chars'
        db.delete_column('extractor_mappingunittouser', 'unmarked_chars')
