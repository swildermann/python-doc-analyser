...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('extractor_markedunit', (
            ...
            ('knowledge_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['extractor.KnowledgeType'])),
    ...
    models = {
        ...
        'extractor.markedunit': {
            ...
            'html_text': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'knowledge_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['extractor.KnowledgeType']"}),
