...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DocumentationUnit.end_offset'
        db.delete_column('extractor_documentationunit', 'end_offset')

        # Deleting field 'DocumentationUnit.start_offset'
        db.delete_column('extractor_documentationunit', 'start_offset')

        # Adding field 'DocumentationUnit.length'
        db.add_column('extractor_documentationunit', 'length',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DocumentationUnit.end_offset'
        db.add_column('extractor_documentationunit', 'end_offset',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DocumentationUnit.start_offset'
        db.add_column('extractor_documentationunit', 'start_offset',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'DocumentationUnit.length'
        db.delete_column('extractor_documentationunit', 'length')
