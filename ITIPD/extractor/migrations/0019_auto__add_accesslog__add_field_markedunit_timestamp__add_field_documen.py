...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('extractor_accesslog', (
            ...
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=100, default='')),
        ))
        db.send_create_signal('extractor', ['AccessLog'])

        # Adding field 'MarkedUnit.timestamp'
        db.add_column('extractor_markedunit', 'timestamp',
                      self.gf('django.db.models.fields.TimeField')(default=0),
                      keep_default=False)

        # Adding field 'DocumentationUnit.type'
        db.add_column('extractor_documentationunit', 'type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MarkedUnit.timestamp'
        db.delete_column('extractor_markedunit', 'timestamp')

        # Deleting field 'DocumentationUnit.type'
        db.delete_column('extractor_documentationunit', 'type')
