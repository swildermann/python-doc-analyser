...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccessLog.timestamp'
        db.add_column('extractor_accesslog', 'timestamp',
                      self.gf('django.db.models.fields.TimeField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccessLog.timestamp'
        db.delete_column('extractor_accesslog', 'timestamp')
