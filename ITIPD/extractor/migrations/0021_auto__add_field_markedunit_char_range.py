...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarkedUnit.char_range'
        db.add_column('extractor_markedunit', 'char_range',
                      self.gf('django.db.models.fields.TextField')(max_length=500, default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarkedUnit.char_range'
        db.delete_column('extractor_markedunit', 'char_range')
